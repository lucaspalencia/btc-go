...
func getMarketDataCommand(c *cli.Context) error {
	...
	fmt.Println("Market Cap:", data.MarketCap)
	fmt.Println("Market volume in 24 hours:", data.MarketVolume)
	fmt.Println("Market percentage in 24 hours:", data.MarketPercentage)
